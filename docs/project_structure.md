...
* ## ui 文件夹  
  ...
  **注意： 这里所说的编译不仅仅是编译源代码，还包括对 ui文件的预处理，以及模板代码的生成等一系列处理，但是这些都是自动化的，你无需手动处理。编译这一动作背后的所有具体操作，请参考 [具体编译过程以及UI文件与源代码的对应关系](how_to_compile_flythings#ftu_and_source_relationships)，看完后，相信你会更容易理解，并且快速上手开发**
